...
private:
    ...
    void runPointerAnalysis(llvm::Module& module, u32_t kind);
		...
		void outputReachResult(llvm::Module* module, std::string filepath);

		void outputOutGoingEdges(llvm::Module* module, std::string filepath);
    ...
    PointerAnalysis* _pta;	///<  pointer analysis to be executed.
		...
		llvm::GlobalBBDomTree* globalBBDomTree; // global basic block dominator tree

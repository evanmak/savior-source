...
public:
    ...
    } equalGEdge; // it should be a less predicate
...
public:
    ...
    /// Edge iterator
    ///@{
		// typename is needed before a qualified dependent type
...
public:
    ...
    inline bool addIncomingEdge(EdgeType* inEdge) {
        return InEdges.insert(inEdge).second; // insert will return a pair <iterator, bool>
    }

...
entry:
  %.reg2mem = alloca i32
  %i.04.reg2mem = alloca i32
  %i.04.reg2mem5 = alloca i32
  ...
  store i32 0, i32* %i.04.reg2mem5
  br label %for.body, !dbg !33

for.body:                                         ; preds = %for.cond.backedge.for.body_crit_edge, %entry
  %i.04.reload6 = load i32* %i.04.reg2mem5
  store i32 %i.04.reload6, i32* %i.04.reg2mem
  %0 = load %struct._IO_FILE** @stdin, align 8, !dbg !34, !tbaa !38
  %call.i = tail call i32 @_IO_getc(%struct._IO_FILE* %0) #4, !dbg !42
  %i.04.reload4 = load i32* %i.04.reg2mem
  %1 = icmp ult i32 %i.04.reload4, 256, !dbg !43
  br i1 %1, label %for.body.cont_crit_edge, label %handler.out_of_bounds, !dbg !43, !prof !44, !nosanitize !2, !afl_edge_sanitizer !2

for.body.cont_crit_edge:                          ; preds = %for.body
  br label %cont, !dbg !43

handler.out_of_bounds:                            ; preds = %for.body
  %i.04.reload3 = load i32* %i.04.reg2mem
  %2 = zext i32 %i.04.reload3 to i64, !dbg !45, !nosanitize !2
...
cont:                                             ; preds = %handler.out_of_bounds, %for.body.cont_crit_edge
  %i.04.reload2 = load i32* %i.04.reg2mem
  %3 = tail call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %i.04.reload2, i32 1), !dbg !47
  %4 = extractvalue { i32, i1 } %3, 0, !dbg !47
  store i32 %4, i32* %.reg2mem
  %5 = extractvalue { i32, i1 } %3, 1, !dbg !47
  br i1 %5, label %handler.add_overflow, label %cont.for.cond.backedge_crit_edge, !dbg !47, !prof !48, !nosanitize !2, !afl_edge_sanitizer !2

cont.for.cond.backedge_crit_edge:                 ; preds = %cont
  br label %for.cond.backedge, !dbg !47

for.cond.backedge:                                ; preds = %handler.add_overflow, %cont.for.cond.backedge_crit_edge
  %.reload = load i32* %.reg2mem
  %cmp = icmp slt i32 %.reload, 256, !dbg !49
  br i1 %cmp, label %for.cond.backedge.for.body_crit_edge, label %for.end, !dbg !33

for.cond.backedge.for.body_crit_edge:             ; preds = %for.cond.backedge
  %.reload1 = load i32* %.reg2mem
  store i32 %.reload1, i32* %i.04.reg2mem5
  br label %for.body, !dbg !33

handler.add_overflow:                             ; preds = %cont
  %i.04.reload = load i32* %i.04.reg2mem
  %6 = zext i32 %i.04.reload to i64, !dbg !52, !nosanitize !2

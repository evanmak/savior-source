...
@3 = private unnamed_addr global { { [11 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* } { { [11 x i8]*, i32, i32 } { [11 x i8]* @.src, i32 11, i32 8 }, { i16, i16, [6 x i8] }* @1 }
...
if.else:                                          ; preds = %entry
  ...
  %12 = call { i32, i1 } @llvm.sadd.with.overflow.i32(i32 %11, i32 1), !dbg !41
  %13 = extractvalue { i32, i1 } %12, 0, !dbg !41
  %14 = extractvalue { i32, i1 } %12, 1, !dbg !41
  %15 = xor i1 %14, true, !dbg !41, !nosanitize !2
  br i1 %15, label %cont1, label %handler.add_overflow, !dbg !41, !prof !34, !nosanitize !2, !afl_edge_sanitizer !2

handler.add_overflow:                             ; preds = %if.else
  %16 = zext i32 %11 to i64, !dbg !43, !nosanitize !2
  call void @__ubsan_handle_add_overflow(i8* bitcast ({ { [11 x i8]*, i32, i32 }, { i16, i16, [6 x i8] }* }* @3 to i8*), i64 %16, i64 1) #5, !dbg !43, !nosanitize !2
  br label %cont1, !dbg !43, !nosanitize !2

cont1:                                            ; preds = %handler.add_overflow, %if.else
  store i32 %13, i32* %i, align 4, !dbg !45
  br label %if.end
